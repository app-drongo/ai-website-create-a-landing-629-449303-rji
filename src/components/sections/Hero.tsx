        ...
        <div className="grid items-center gap-12 py-20 sm:py-24 lg:grid-cols-2 lg:gap-20 lg:py-32">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-muted-foreground">
              Connect to 500+ financial institutions with OpenFlow's secure API platform. Build next-generation banking experiences with enterprise-grade reliability.
            </p>
          ...
          <div className="relative">
            ...
            <div className="absolute -left-6 -bottom-6 hidden w-36 rounded-xl border bg-background/90 p-3 shadow-xl sm:block">
              ...
              <p className="text-sm">
                <span className="font-semibold">AAA</span> rated
              </p>
            </div>
          </div>
        </div>
